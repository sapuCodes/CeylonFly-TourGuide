...
colombo.attr({ title: 'Colombo', id: 'd1', fill: ' rgb(255, 192, 0)', stroke: ' rgb(247, 247, 247)', " stroke-width": ' 1.01433px', 'stroke-opacity': '1' }).data('id', 'd1');

// Get the bounding box (BBox) of the district
var bbox = colombo.getBBox();
// Add a number to the center of Colombo
var districtName = "Colombo";
var xOffset = -10;
var label = rsr.text(bbox.x + bbox.width / 2+xOffset, bbox.y + bbox.height / 2, districtName).attr({
    "font-size": 16,
...
colombo.click(function() {
    const district = encodeURIComponent("Colombo");
    window.location.href = `category.jsp?district=${district}`;
});

//to make name text unusable/ click through
...
gampaha.attr({ title: 'Gampaha', id: 'd2', fill: ' rgb(255, 192, 0)', stroke: ' rgb(247, 247, 247)', " stroke-width": ' 1.01433px', 'stroke-opacity': '1' }).data('id', 'd2');

// Get the bounding box (BBox) of the district
var bbox = gampaha.getBBox();
// Add a number to the center
var districtName = "Gampaha";
var xOffset = -10;
var label = rsr.text(bbox.x + bbox.width / 2+xOffset, bbox.y + bbox.height / 2, districtName).attr({
    "font-size": 16,
    "font-family": "Arial, sans-serif",
...
// Action to perform when clicked
gampaha.click(function() {
    const district = encodeURIComponent("Gampaha");
    window.location.href = `category.jsp?district=${district}`;
});
...
label.node.style.pointerEvents = 'none';
// Action to perform when clicked
kegalle.click(function() {
    window.location.href = 'kegalle.html'; 
});


// Iterate through districts and bind mouseover and mouseout events
for (let i = 0; i < districts.length; i++) {
    districts[i].mouseover(function (e) {
        this.node.style.opacity = 0.7;
        document.getElementById('district-name').innerHTML = this.attr('title');
    });
